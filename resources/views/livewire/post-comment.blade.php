<div>
    <form wire:submit="leaveComment">
        <div class="form-group">
            <textarea wire:model="comment" class="form-control" cols="30" rows="3" placeholder="Comment"></textarea>
            @error('comment')
