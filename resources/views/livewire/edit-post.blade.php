    ...
    <div class="card-body">
        ...
        <div class="col-sm-10">
            <div class="form-floating mb-3">
                <input type="text" class="form-control" wire:model="post_title" value="{{$post->post_title}}" id="floatingInput" placeholder="Title">
        ...
        <div class="col-sm-10">
            <div class="form-floating mb-3">
                <input type="text" class="form-control" wire:model="content" value="{{$post->content}}" id="floatingInput" placeholder="Text">
                <label for="floatingInput">Content</label>
            </div>
            @error('content')
                <span class="text-danger">{{$message}}</span><div class="card">
        ...
        <div class="col-sm-10">
            ...
            @enderror
                ...
                <button type="submit" class="btn btn-primary">Update</button>
                <a href="/my/posts" wire:navigate class="btn btn-danger">Cancel</a>
        </div>
    </form>
    </div>
</div>
